...
export const initialResumeStateRu = {
  ...
  basic: {
    ...
    employementStatus: "Открыт к предложениям",
  ...
  education: [
    {
      ...
      gpa: "",
      description: `<ul>
        <li>Основные курсы: структуры данных, проектирование алгоритмов, операционные системы, компьютерные сети, веб-разработка</li>
        <li>Топ-5% курса, три года подряд получал повышенную стипендию</li>
        <li>Руководил техническим отделом студенческого IT-сообщества, организовывал технические встречи</li>
        <li>Участвовал в open-source проектах, получил сертификат GitHub Campus Expert</li>
      </ul>`,
    },
  ],
  skillContent: `<div class="skill-content">
  <ul>
    <li>Фронтенд-фреймворки: React, Vue.js, Next.js, Nuxt.js и другие SSR-фреймворки</li>
    <li>Языки: TypeScript, JavaScript (ES6+), HTML5, CSS3</li>
    <li>UI/стили: TailwindCSS, Sass/Less, CSS Modules, Styled-components</li>
    ...
    <li>Производительность: принципы рендеринга браузера, мониторинг метрик, code splitting, ленивая загрузка</li>
    <li>Контроль версий: Git, SVN</li>
    <li>Техническое лидерство: опыт управления командой, выбор технологий и проектирование архитектуры крупных проектов</li>
  </ul>
</div>`,
  selfEvaluationContent: "",
  experience: [
    {
      ...
      visible: true,
      details: `<ul>
      <li>Отвечал за разработку и поддержку платформы для авторов, вёл проектирование технических решений ключевых функций</li>
      <li>Оптимизировал конфигурацию сборки, сократив время сборки с 8 до 2 минут и повысив эффективность команды</li>
      <li>Спроектировал и внедрил библиотеку компонентов, повысив переиспользование кода на 70%</li>
      <li>Руководил проектом оптимизации производительности, сократив время загрузки первого экрана на 50%, внедрил APM-мониторинг</li>
      <li>Наставлял младших разработчиков, проводил технические встречи для повышения уровня команды</li>
    </ul>`,
    },
  ],
  draggingProjectId: null,
  projects: [
    {
      id: "p1",
      name: "Платформа для авторов контента",
      role: "Ведущий фронтенд-разработчик",
      date: "2022.06 - 2023.12",
      description: `<ul>
        <li>Платформа аналитики и управления контентом на React, обслуживающая миллионы авторов</li>
        <li>Включает подсистемы аналитики данных, управления контентом и доходами</li>
        <li>Использован Redux для управления состоянием и эффективной обработки сложных потоков данных</li>
        <li>Применена библиотека компонентов Ant Design для единообразия интерфейса</li>
        <li>Реализованы code splitting и ленивая загрузка для оптимизации производительности</li>
      </ul>`,
      visible: true,
    },
    {
      id: "p2",
      name: "Инструменты разработчика мини-приложений",
      role: "Ключевой разработчик",
      date: "2020.03 - 2021.06",
      description: `<ul>
        <li>Комплексное решение для разработки, отладки и публикации мини-приложений</li>
        <li>Кроссплатформенное десктопное приложение на Electron</li>
        <li>Поддержка Windows, macOS и Linux</li>
        <li>Логирование ошибок и инструменты анализа производительности в реальном времени</li>
        <li>Интеграция сторонних плагинов и SDK для расширения функциональности</li>
      </ul>`,
      visible: true,
    },
    {
      ...
      date: "2021.09 - 2022.05",
      description: `<ul>
        <li>Полноценное решение для мониторинга фронтенда: отслеживание ошибок, производительности и поведения пользователей</li>
        <li>Построено на Vue и Element UI, предоставляет данные мониторинга и инструменты визуализации в реальном времени</li>
        <li>Поддержка различных метрик: логи ошибок, показатели производительности, анализ поведения пользователей</li>
        <li>Детальные логи ошибок и инструменты анализа для поиска и устранения проблем</li>
        <li>Интеграция сторонних плагинов и SDK для расширения функциональности</li>
      </ul>`,
      visible: true,
    },
  ...
  menuSections: [
    { id: "basic", title: "Личные данные", icon: "👤", enabled: true, order: 0 },
    {
      id: "skills",
